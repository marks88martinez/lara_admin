                                                    ...
                                                    <div class="col-lg-12">
                                                        ...
                                                        <form action="{{ route('blogs.store') }}" method="POST">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" name="titulo" id="example-palaceholder" class="form-control" placeholder="titulo">
                                                            </div>

                                                            <div class="mb-3">
                                                                <label for="example-textarea"  class="form-label">Contenido</label>
                                                                <textarea class="form-control" name="contenido" id="example-textarea" rows="5"></textarea>
                                                            </div>
                                                            <div class="mb-3">
